...
export function Mp4Icon({ size, checked, onClick }) {
  return (
    <Wrap checked={checked} size={size} onClick={onClick}>
      <svg
        viewBox="0 0 512 512"
