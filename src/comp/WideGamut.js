  ...
  svg {
    ${({ active, size }) =>
      active
        ? size === "small"
          ? `display: block;
      stroke: var(--Green-Gradient, color(display-p3 .4588 .9804 .298));`
          : "display:block;stroke: #000;"
        : "display: none;"}
  }
  ${CSSpan} {
    ${({ active, size }) =>
      active
        ? size === "small"
          ? `border-color: var(--Green-Gradient, color(display-p3 .4588 .9804 .298));`
          : `
    border-color: transparent;
    background-color: var(--Green-Gradient, #00FF00);
    background-color: var(--Green-Gradient, color(display-p3 .4588 .9804 .298))
    `
        : ""}
    ${({ size }) =>
      size === "small"
